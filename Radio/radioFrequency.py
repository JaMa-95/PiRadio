...
min_value = 0
max_value_kurz_mittel_lang = 3400
max_value_ukw = 875
...
class KurzFrequencies:
    ...
    def __init__(self):
        self.frequencies = [
            ...
            RadioFrequency("Stuttgart", 421, 488, "Energy Stuttgart", "http://nrj.de/stuttgart"),
            RadioFrequency("Frankfurt", 488, 614, "", "http://addrad.io/4454thr"),
            # http://dispatcher.rndfnk.com/rbb/radioeins/frankfurt/mp3/mid
            RadioFrequency("Brüssel", 614, 872, "", "http://icecast-servers.vrtcdn.be/stubru_hiphophooray-high.mp3"),
            RadioFrequency("Rias Berlin", 872, 1044, "The Indie Blend",
            ...
            RadioFrequency("Östersund", 1044, 1123, "Radio Svensk",
            ...
            RadioFrequency("Mailand", 1596, 1681, "Cenralo Milano", "http://streaming.centralemilano.com/m3u"),
            RadioFrequency("Brüssel", 1681, 1772, "stubru hiphophooray high",
                           "http://icecast-servers.vrtcdn.be/stubru_hiphophooray-high.mp3"),
            RadioFrequency("Hamburg", 1772, 1825, "Tidenet", "http://streaming.tidenet.de:8000/tide-192.mp3"),
            RadioFrequency("Göteborg", 1825, 1858, "", "http://184.154.43.106:8243/stream"),
            RadioFrequency("Rias Berlin", 1858, 1886, "Berlin Bohème",
                           "http://streams.fluxfm.de/berlinboheme/mp3-320/streams.fluxfm.de/"),
            RadioFrequency("Hilversum", 1886, 1919, "Amsterdam", "http://stream.zenolive.com/cfpp8xvs6neuv"),
            # https://stream.amsterdamsmostwanted.nl/8000
            RadioFrequency("Südwestfunk", 1919, 2130, "Das Ding", "https://liveradio.swr.de/tn8jep3/dasding/"),
            RadioFrequency("Straßburg", 2130, 2265, "Radio Judaica Strasbourg",
                           "http://radiojudaicastrasbourg.ice.infomaniak.ch/radiojudaicastrasbourg-128.mp3"),
            # https://www.radioking.com/play/radio-rbs-1
            RadioFrequency("Süddeutscher Rundfunk", 2265, 2295, "SWR1", "https://liveradio.swr.de/sw282p3/swr1bw/"),
            RadioFrequency("Hörby", 2295, 2352, "Malmö", "http://n0b.radiojar.com:80/bbhah441b6quv"),
            RadioFrequency("Falun", 2352, 2518, "P4 Dalarna", "https://sverigesradio.se/topsy/direkt/223-hi.mp3"),
            RadioFrequency("Bremen", 2518, 2716, "Radio Bremen",
                           "http://icecast.radiobremen.de/rb/bremennext/live/mp3/128/stream.mp3"),
            RadioFrequency("SV Rel", 2716, 2788, "Valencia", "https://streams.radio.co/sebb274c66/listen"),
            RadioFrequency("Saarbrücken", 2788, 2818, "", "https://addrad.io/4454wbr"),
            RadioFrequency("Luxemburg", 2818, 2917, "rfm luxembourg",
...
class UKWFrequencies:
    def __init__(self):
        self.frequencies = [
            ...
            RadioFrequency("Classic relax", 0, 100, "YourClassical Relax", "https://relax.stream.publicradio.org/relax.mp3?srcid"),
            ...
            RadioFrequency("Nature", 0, 100, "Epic Lounge - Nature Sounds", "https://stream.epic-lounge.com/nature-sounds?ref"),
            ...
            RadioFrequency("Cafe", 0, 100, "Epic Lounge - Coffee Bar Lounge", "https://stream.epic-lounge.com/coffee-bar-lounge?ref"),
            RadioFrequency("Romantisch", 0, 100, "EPIC CLASSICAL - Classical Romance", "https://stream.epic-classical.com/classical-romance?ref"),
            RadioFrequency("Dark night", 0, 100, "Techno FM", "http://stream.techno.fm/radio320.mp3"),
            RadioFrequency("Christmas Loung", 0, 100, "Epic Lounge - Christmas Lounge", "https://stream.epic-lounge.com/christmas-lounge?ref"),
        ]
        self.init_min_max()
...
class SprFrequencies:
    ...
    def __init__(self):
        ...
        self.frequencies = [
            ...
            RadioFrequency("Latinamerika", 0, 100, "LATIN MIX MASTERS REGGAETON RADIO", "https://lmmradiocast.com/radio/8010/radio.mp3?1590197168"),
            RadioFrequency("Latinamerika", 0, 100, "LATIN MIX MASTERS RADIO", "https://lmmradiocast.com/radio/8000/radio.mp3?1587013766"),
            ...
            RadioFrequency("Amerika", 0, 100, "Radio England", "https://streaming02.zfast.co.uk/proxy/england?mp=/stream"),
            RadioFrequency("England", 0, 100, "Gaydio London", "https://listen-gaydio.sharp-stream.com/472_gaydio_london_320_mp3"),
            RadioFrequency("England", 0, 100, "London Music Radio", "https://radiobossrelay.radioca.st/stream"),
            RadioFrequency("Australia", 0, 100, "LoveWorld Radio Australia", "http://stream.radio.co/s0a970f188/listen"),
            RadioFrequency("Australia", 0, 100, "THEAUSSIEWORD Radio Australia", "http://jenny.torontocast.com:8108/stream"),
            RadioFrequency("Frankreich", 0, 100, "France Bleu Normandie", "http://direct.francebleu.fr/live/fbbassenormandie-midfi.mp3?ID=76zqey582k"),
            RadioFrequency("Frankreich", 0, 100, "NRJ MADE IN FRANCE", "https://scdn.nrjaudio.fm/adwz1/fr/31217/mp3_128.mp3?origineradio"),
            # deutsch
            ...
            RadioFrequency("Ukraine", 0, 100, "Classic Radio Ukraine", "https://online.classicradio.com.ua/ClassicRadio"),
